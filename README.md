...
*   **Development & Versioning**: For developers interested in releasing patches or understanding the CalVer pipeline, see our development guide at `docs/versioning_guide.md` inside the codebase.
